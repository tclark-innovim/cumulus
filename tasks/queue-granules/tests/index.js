...
test.serial('does not change collection id on granule', async (t) => {
  ...
  event.input.granules = [
    {
      granuleId: 'granule-1',
      dataType: 'http_testcollection_test-squinlan-DiscoverGranules-1686092642035',
      version: '001',
      files: [
        { name: 'granule-1.nc', path: 'granules/fake_granules', bucket: 'squinlan-internal', url_path: '', type: 'data' }, { name: 'granule-1.nc.md5', path: 'granules/fake_granules', bucket: 'squinlan-internal', url_path: '', type: 'metadata' },
      ],
    },
    {
      granuleId: 'granule-2',
      ...
      version: '001',
      files: [
        { name: 'granule-2.nc', path: 'granules/fake_granules', bucket: 'squinlan-internal', url_path: '', type: 'data' }, { name: 'granule-2.nc.md5', path: 'granules/fake_granules', bucket: 'squinlan-internal', url_path: '', type: 'metadata' },
      ],
    },
    {
      granuleId: 'granule-3',
      ...
      version: '001',
      files: [
        { name: 'granule-3.nc', path: 'granules/fake_granules', bucket: 'squinlan-internal', url_path: '', type: 'data' }, { name: 'granule-3.nc.md5', path: 'granules/fake_granules', bucket: 'squinlan-internal', url_path: '', type: 'metadata' },
      ],
    },
  ];
  const enqueueGranuleIngestMessageMock = sinon.spy((params) => params);
